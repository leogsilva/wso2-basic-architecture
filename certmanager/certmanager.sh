...
# pe "kubectl apply -f issuer-letsencrypt-production.yaml -n gateway"
# pe "kubectl get issuer -n gateway"
# pe "kubectl apply -f gateway-certificate-production.yaml -n gateway"
# pe "kubectl get certificate -n gateway"
